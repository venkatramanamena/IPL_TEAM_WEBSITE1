...
//     var store = [];
//     store.push(obj);
//     localStorage.setItem("TeamDetails", JSON.stringify(store));
//   } else {
//     TeamDetails.push(obj);
...
var grid = document.getElementById("grid");
    ...
    for (var i = 0; i < homePageDetails.length; i++) {
      console.log(`${homePageDetails[i].team}`);
        grid.innerHTML += `
        <div class="gridcontent" onclick="teamdetails(${homePageDetails[i].teamNUmber})">
        <img src="${homePageDetails[i].playerimage}">
        <h3>${homePageDetails[i].team}</h3>
        <h3>${homePageDetails[i].playerName}</h3>
        <p>${homePageDetails[i].description}</p>
    </div>`
      }
...
{
  sessionStorage.setItem("indexValue",JSON.stringify(id));

  location.assign("teamDetailsPage.html");
...
function addplayer()
{
  location.assign("addplayer.html");
}

function ap(){
  var playerName1 = document.getElementById("playerName");
var playerimage1 = document.getElementById("playerimage");
...
console.log(playerName1.value,playerimage1.value,team1.value,price1.value,role1.value);
...
var obj = {
  ...
  playerimage: playerimage1.value,
  team: team1.value,
  price: price1.value,
  role: role1.value,
}
if(playerLocalStorage == null )
    {
        ...
        localStorage.setItem("newplayer",JSON.stringify(prod));
        

    }
    else{
        playerLocalStorage.push(obj);
  
        localStorage.setItem("newplayer",JSON.stringify(playerLocalStorage));
